...
<form action="../../controls/activite/traitement.php" method="POST" id="inscActivite">
  <div class="form-group">
    ...
    <input name="CODEETATACT" id="CODEETATACT" type="hidden" class="form-control" placeholder="LB">
  ...
  <div class="form-group col-10">
	...
	<div class="form-group col-10">
			...
			<input name="HRDEBUTACT" id="HRDEBUTACT" type="time" class="form-control" placeholder="ex : 11:00">
	</div>
	<div class="form-group col-10">
		<label for="hrFinActivite">Heure Fin</label>
		<input name="HRFINACT" id="HRFINACT" type="time" class="form-control" placeholder="12:00">
	</div>
		<input name="DATEANNULEACT" id="DATEANNULEACT" type="hidden" class="form-control">
	<div class="form-group">
